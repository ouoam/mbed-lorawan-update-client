 ...
 */
BDFILE::BDFILE(FragmentationBlockDeviceWrapper* _bd, size_t _offset, size_t _size) :
 ...
 */
int BDFILE::fseek(long int pos, int origin) {
    switch (origin) {
...
size_t BDFILE::fread(void *buffer, size_t elements, size_t element_size) {
...
size_t BDFILE::fwrite(const void *buffer, size_t elements, size_t size) {
